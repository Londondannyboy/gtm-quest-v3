  ...
  return (
    <section className="py-20 bg-gradient-to-b from-zinc-950 to-black overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          {/* Glow effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-blue-500/20 to-purple-500/20 blur-3xl opacity-30" />
          ...
          <div className="relative bg-zinc-900/80 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/10">
              ...
              <div className="text-white/40 text-sm">GTM Quest Dashboard</div>
              <div className="text-emerald-400 text-sm font-medium">Live Preview</div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className={`bg-gradient-to-br ${feature.gradient} rounded-xl p-5 border border-white/10`}
                >
        ...
        >
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition shadow-lg shadow-emerald-500/25"
          >
            Try the Dashboard
