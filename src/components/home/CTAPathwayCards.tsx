            ...
            >
              <div className="flex flex-col h-full">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="bg-green-700 text-white text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wide">
                        Recommended
                      </span>
                    </div>
                ...
                <div className="mt-auto">
                  <span className="inline-flex items-center gap-2 bg-green-700 hover:bg-green-800 text-white px-6 py-3 rounded-xl font-bold text-lg transition">
